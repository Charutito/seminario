...
Shader "ToonShaderAMp"
{
	Properties
	{
		...
		_ToonMultiPlyer("ToonMultiPlyer", Range( 0 , 1)) = 0.8296579
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( tex2D( _Dioffuse, uv_Dioffuse ) * tex2D( _ToonRamp, temp_cast_0 ) ) * _ToonMultiPlyer ).xyz;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=13101
0;92;938;295;883.3575;690.4405;2.722242;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1106.354,130.0598;Float;False;Property;_ToonScale;ToonScale;1;0;10;-10;10;0;1;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;22;-249.3836,-52.98589;Float;True;Property;_ToonRamp;ToonRamp;2;0;Assets/Textures/Luts/lu7.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=C0A030AF751AB84146125F1AF6ED11148EEB37DB